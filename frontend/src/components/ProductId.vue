<template>
    <v-card outlined @click="openDialog">
        <v-card-title>
            basic.Product : {{ referenceValue ? referenceValue.name : '' }}
        </v-card-title>

        <v-dialog v-model="pickerDialog">
            <v-card>
                <v-card-title>basic.Product</v-card-title>
                <v-card-text>
                    <basic.ProductPicker v-model="value" @selected="pick"/>
                </v-card-text>
                <v-card-actions>
                    <v-spacer></v-spacer>
