<template>
    <div style="max-height:80vh;">
        <div class="gs-bundle-of-buttons" style="max-height:10vh;">
                <v-btn @click="addNewRow" small color="primary" :disabled="!userRoles.includes('SalesPerson')">
                    <v-icon small>mdi-plus-circle-outline</v-icon>등록
                </v-btn>
                <v-btn  @click="editSelectedRow" small color="primary" :disabled="!userRoles.includes('SalesPerson')">
                    <v-icon small>mdi-pencil</v-icon>수정
                </v-btn>
                <v-btn @click="deleteSelectedRows" small color="primary" :disabled="!userRoles.includes('SalesPerson')">
        ...
        >
            ...
            <wj-flex-grid-column binding="salesType" header="수주종류" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="salesItems" header="수주항목" width="2*" :isReadOnly="true" align="center" />
